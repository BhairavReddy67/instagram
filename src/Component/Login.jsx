...
function Login() {
    const {handleAuth,userName,setUsername,Password,setPassword}=React.useContext(ContextApi)
        ...
        <div className="Inst_login">
            ...
            <div>
                <div className="form">
                    ...
                    <button onClick={()=>handleAuth()} style={{margin:"2px",background:"blue",color:"white",width:"80%",height:"40px",fontSize:"15px",border:"1px solid blue"}}>Login</button>
                </div>
            </div>
        </div>
    )
